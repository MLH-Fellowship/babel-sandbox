...
const BuiltIns = {
  ...
  Observable: define("observable", ["esnext.observable", "esnext.symbol.observable", "es.object.to-string", ...CommonIteratorsWithTag]),
...
const StaticProperties = {
  ...
  Promise: {
    ...
    allSettled: define(null, ["esnext.promise.all-settled", ...PromiseDependenciesWithIterators]),
