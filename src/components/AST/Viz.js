...
import { StyledAccordion, StyledAccordionTitle } from "../styles";
...
function CompositeObj({ k, obj, cursor, setPos, ...other }) {
    ...
    const panels = [
      {
        key: 0,
        content: (
          <Composite k="" ast={ast.program} cursor={cursor} setPos={setPos} />
        ),
      },
    ];
