...
import { publish } from '../../../../ASTExplorer/utils/pubsub.js'
...
import stringify from '../../../../ASTExplorer/utils/stringify'
...
const Element = React.memo(
  function Element({
    ...
    const opensByDefault =
      useMemo(() => treeAdapter.opensByDefault(value, name), [
        treeAdapter,
        value,
        name,
      ]) || level === 0
